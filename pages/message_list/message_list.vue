<template>
	<view class="page">
		<uni-list>
			<uni-chat v-for="one in list" :key="one.id" :title="one.senderName"
...
<script>
	...
	import uniChat from '@/components/components/uni-list-chat/uni-list-chat.vue';
	import uniAd from '@/components/components/uni-list-ad/uni-list-ad.vue';
	export default {
		components:{
			uniList,
			uniListItem,
